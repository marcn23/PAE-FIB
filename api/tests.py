...
if __name__ == '__main__':
    ...
    act2 = Act("Testing2", "Test_name", "Barcelona", "Barcelona", "26/11/2023", "30/11/2023", [song1,song2])
    ...
    cs.collect_XLSX_data(org)
    print("OK")
    file_path = os.path.normpath(os.path.join(os.getcwd(),'in','CSVs','Programs',str(org.name) +'_ProgramInput.csv'))
