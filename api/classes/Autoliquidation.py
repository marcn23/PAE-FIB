...
class Autoliquidation:
    ...
    def __init__(self, audition_days,audition_price,contest_days,contest_price,num_couplets,concert_days,concert_earnings, acts: [Act]):
        ...
        self.acts : [Act] = acts if acts else []
